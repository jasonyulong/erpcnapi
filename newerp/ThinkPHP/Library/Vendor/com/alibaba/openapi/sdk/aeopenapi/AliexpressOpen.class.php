...
class AliexpressOpen {
	...
	public function refreshToken($refreshToken) {
        ...
        public function apiEditSingleSkuStock(ApiEditSingleSkuStockParam $param,   $accessToken) {
            $reqPolicy = new RequestPolicy();
            $reqPolicy->httpMethod="POST";
            $reqPolicy->needAuthorization=true;
            $reqPolicy->requestSendTimestamp=false;
            ...
            return $this->getAPIClient()->send($request, null,
						$reqPolicy);
        }
                                                        
            
           
        public function apiEditSingleSkuPrice(ApiEditSingleSkuPriceParam $param,   $accessToken) {
            $reqPolicy = new RequestPolicy();
            $reqPolicy->httpMethod="POST";
            $reqPolicy->needAuthorization=true;
            $reqPolicy->requestSendTimestamp=false;
         ...
         * @param $accessToken
         */
        public function apiGetChildrenPostCategoryById($id, $accessToken) {
            ...
            $request = new APIRequest ();
            $apiId = new APIId ("aliexpress.open", "api.getChildrenPostCategoryById", 1);
            $request->apiId = $apiId;
            $request->addtionalParams = array('cateId' => $id);
         ...
         * @param $accessToken
         */
        public function getChildAttributesResultByPostCateIdAndPath($id, $accessToken) {
            $reqPolicy = new RequestPolicy();
            $reqPolicy->httpMethod="POST";
            $reqPolicy->needAuthorization=true;
            $reqPolicy->requestSendTimestamp=false;
            ...
            $request = new APIRequest ();
            $apiId = new APIId ("aliexpress.open", "getChildAttributesResultByPostCateIdAndPath", 1);
            $request->apiId = $apiId;
            $request->addtionalParams = array('cateId' => $id);
         ...
         * @return mixed
         */
        public function apiListFreightTemplate($accessToken) {
            $reqPolicy = new RequestPolicy();
            $reqPolicy->httpMethod="POST";
            $reqPolicy->needAuthorization=true;
            $reqPolicy->requestSendTimestamp=false;
            ...
            $request = new APIRequest ();
            $apiId = new APIId ("aliexpress.open", "api.listFreightTemplate", 1);
            $request->apiId = $apiId;
         ...
         * @return mixed
         */
        public function recommendCategoryByKeyword($keyWord,$accessToken){
            $reqPolicy = new RequestPolicy();
            $reqPolicy->httpMethod="POST";
            $reqPolicy->needAuthorization=true;
            $reqPolicy->requestSendTimestamp=false;
            ...
            $request = new APIRequest ();
            $apiId = new APIId ("aliexpress.open", "api.recommendCategoryByKeyword", 1);
            $request->apiId = $apiId;
            $request->addtionalParams = array('keyword' => $keyWord);
     ...
     * 查询运费模板
     *
     * @param ApiQueryPromiseTemplateByIdParam $param
     * @param $accessToken
     * @return mixed
     */
        public function apiQueryPromiseTemplateById(ApiQueryPromiseTemplateByIdParam $param,   $accessToken) {
            $reqPolicy = new RequestPolicy();
            $reqPolicy->httpMethod="POST";
            $reqPolicy->needAuthorization=true;
            $reqPolicy->requestSendTimestamp=false;
        ...
        public function apiFindAeProductDetailModuleListByQurey(ApiFindAeProductDetailModuleListByQureyParam $param,   $accessToken) {
            $reqPolicy = new RequestPolicy();
            $reqPolicy->httpMethod="POST";
            $reqPolicy->needAuthorization=true;
            $reqPolicy->requestSendTimestamp=false;
        ...
        public function apiFindAeProductModuleById(ApiFindAeProductModuleByIdParam $param,   $accessToken) {
            $reqPolicy = new RequestPolicy();
            $reqPolicy->httpMethod="POST";
            $reqPolicy->needAuthorization=true;
            $reqPolicy->requestSendTimestamp=false;
        ...
        public function apiOnlineAeProduct(ApiOnlineAeProductParam $param,   $accessToken ) {
            $reqPolicy = new RequestPolicy();
            $reqPolicy->httpMethod="POST";
            $reqPolicy->needAuthorization=true;
            $reqPolicy->requestSendTimestamp=false;
