...
namespace Think;
/**
 * @method Model order($field) : 按照指定的字段排序查询结果
 * @method Model alias($name)  : 命名表别名
 * @method Model having($val)  : group by 之后的查询
 * @method Model group($field) :
 * @method Model distinct($field)
 * @method int count()
 * ThinkPHP Model模型类
