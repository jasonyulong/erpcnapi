...
<table class="table table-bordered">
    ...
    <?php if(is_array($dataArr)): $i = 0; $__LIST__ = $dataArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="active">
            <td width="155"><?php echo ($vo["addtime"]); ?></td>
            <td width="120"><?php echo ($vo["adduser"]); ?></td>
