...
*说明: 跨仓单 生成捡货单子
*/
class OrderCrossController extends CommonController
{
...
//        dump($this->allowCarriers);die;
        ...
        $orderResult    = $orderTypeModel->alias('a')
            ...
            ->where([
                ...
                'b.ebay_warehouse'   => $this->current_storeid,
...
//        dump($resultArr);
    ...
    public function getOrderListByCarrier($carrierId, $types) {
        ...
        $map = [
            ...
            'b.pick_status'      => 1,
            'a.ebay_warehouse'   => $this->current_storeid,
        ...
        $map['b.floor'] = $this->current_floor;
        //楼层的问题===== END------------------
...
//        dump($orderInfo);
    ...
    public function updateLeftOrderCount($groupId, $types) {
        ...
        $map['b.ebay_warehouse'] = $this->current_storeid;
        ...
        */
        ...
        $map['a.floor'] =  $this->current_floor;
        //楼层的问题===== END------------------
