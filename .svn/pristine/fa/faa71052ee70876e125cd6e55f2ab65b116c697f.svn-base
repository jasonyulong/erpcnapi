<?php
$titleConfig = require_once "./newerp/Application/Common/Conf/title_config.php";
...
if(!empty($titleConfig)){
    ...
    $urlPath    = isset($parseUrl['path']) ? $parseUrl['path'] : '';
    $urlQuery   = isset($parseUrl['query']) ? $parseUrl['query'] : '';
    foreach ($titleConfig as $kk=>$vv){
        if(strpos($urlPath,$kk) !== false){
            $pageTitle = $vv;
            break;
        }
        if(strpos($urlQuery,$kk) !== false){
            $pageTitle = $vv;
            break;
        }
    }
...
<div id="header" class="no-print">
    ...
    <h1 style="color:#911;padding: 20px;font-size: 20px;margin:0"><?php echo $wmsConfig['STORE_NAMES'][$currStoreId];?></h1>
                ...
                <div class="openDiv">
                    ...
                    <span class="childmod">
                      ...
                      <!--   <a href="/s_auditorder.php?module=orders&action=Loading%20Orders" target="_blank">出库扫描</a> -->
                        ...
                        <a href="http://erp.spocoo.com/t.php?s=/Transport/Test/regetpdfView" target="_blank">物流商面单异常</a>
                    </span>
                </div>
            </li>
            <?php } ?>
...
<!--                            <a href="t.php?s=/Package/UserPackageFee/pickerStatistic.html" target="_blank">拣货统计</a>-->
                            ...
                            <a href="t.php?s=/Package/OrderScanStatistics/index" target="_blank">订单扫描统计</a>
<!--                            <a href="t.php?s=/Package/PickFee/ZreoFeeSKU.html" target="_blank">包装费用为0</a>-->
                            ...
                            <?php if (in_array("orderOutStoreStatistics", $cpower)) { ?>
                            <a href="t.php?s=/Package/Statistics/orderOutStoreStatistics" target="_blank">订单出库报表</a>
                            <?php } ?>
                            <?php if (in_array("skuOutStoreStatistics", $cpower)) { ?>
                            <a href="t.php?s=/Package/Statistics/skuOutStoreStatistics" target="_blank">sku出库报表</a>
                            <?php } ?>
                            <?php if (in_array("orderBaseAnalysisStatistics", $cpower)) { ?>
                                <a href="t.php?s=/Package/Statistics/orderBaseAnalysis" target="_blank">订单基数分析报表</a>
                            <?php } ?>
                            <?php if (in_array("weightFailureStatistics", $cpower)) { ?>
                                <a href="t.php?s=/Package/Statistics/weightFailureIndex" target="_blank">称重失败统计表</a>
                            <?php } ?>
                            <?php if (in_array("abnormalOrderStatistics", $cpower)) { ?>
                                <a href="t.php?s=/Package/Statistics/abnormalOrderIndex" target="_blank">异常订单报表</a>
                            <?php } ?>
                        </span>
                    ...
                    <div class="openDiv">
                        ...
                        <span class="childmod">
                            ...
                            <?php if(in_array('out_weight_rule_set',$cpower)){ ?>
                                ...
                                <a href="/t.php?s=/Package/WeighSystem/weightingIndex" target="_blank">出库称重加权设置</a>
                            <?php }?>
                            <a href="/t.php?s=/Package/Belt/index" target="_blank">传送带层物流</a>
                            <?php if(in_array("unableOrderSetting",$cpower)) { ?>
                            <a href="/t.php?s=/Package/CarrierGroup/unableOrderSetting" target="_blank">无法货找单订单分组配置</a>
                            <?php } ?>
                        </span>
                    </div>
                </li>
